 ...
 * Generation date: Mon May 25 19:51:02 2020
...
/********************************* get_guess *********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_get_guess[] = "\
get_guess()\n\nWrapper for ``get_guess``.\
\n";
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_get_guess(const PyObject *capi_self,
                           PyObject *capi_args,
...
/********************************** mc_step **********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_mc_step[] = "\
...
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_mc_step(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  ...
  if (capi_rthetaphi1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `rthetaphi1' of fodmc.fodmc_mod.mc_step to C/Fortran array" );
  } else {
  ...
  if (capi_center_xyz_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 2nd argument `center_xyz' of fodmc.fodmc_mod.mc_step to C/Fortran array" );
  } else {
    center_xyz = (double *)(PyArray_DATA(capi_center_xyz_tmp));

  /* Processing variable stepsize */
    f2py_success = double_from_pyobj(&stepsize,stepsize_capi,"fodmc.fodmc_mod.mc_step() 3rd argument (stepsize) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_rthetaphi2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting hidden `rthetaphi2' of fodmc.fodmc_mod.mc_step to C/Fortran array" );
  } else {
  ...
  if (capi_xyz2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting hidden `xyz2' of fodmc.fodmc_mod.mc_step to C/Fortran array" );
  } else {
...
/******************************* create_rotmat *******************************/
static char doc_f2py_rout_fodmc_fodmc_mod_create_rotmat[] = "\
...
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_create_rotmat(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:fodmc.fodmc_mod.create_rotmat",\
    capi_kwlist,&stepsize_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable stepsize */
    f2py_success = double_from_pyobj(&stepsize,stepsize_capi,"fodmc.fodmc_mod.create_rotmat() 1st argument (stepsize) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_fullrotmat_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting hidden `fullrotmat' of fodmc.fodmc_mod.create_rotmat to C/Fortran array" );
  } else {
...
/***************************** create_rotmat_bond *****************************/
static char doc_f2py_rout_fodmc_fodmc_mod_create_rotmat_bond[] = "\
...
"fullrotmat : rank-2 array('d') with bounds (3,3)";
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_create_rotmat_bond(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO:fodmc.fodmc_mod.create_rotmat_bond",\
    capi_kwlist,&axis_vector_capi,&stepsize_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable stepsize */
    f2py_success = double_from_pyobj(&stepsize,stepsize_capi,"fodmc.fodmc_mod.create_rotmat_bond() 2nd argument (stepsize) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_axis_vector_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `axis_vector' of fodmc.fodmc_mod.create_rotmat_bond to C/Fortran array" );
  } else {
  ...
  if (capi_fullrotmat_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting hidden `fullrotmat' of fodmc.fodmc_mod.create_rotmat_bond to C/Fortran array" );
  } else {
    fullrotmat = (double *)(PyArray_DATA(capi_fullrotmat_tmp));
...
/********************************* rotate_pos *********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_rotate_pos[] = "\
...
"xyz2 : rank-1 array('d') with bounds (3)";
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_rotate_pos(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:fodmc.fodmc_mod.rotate_pos",\
...
/*frompyobj*/
  ...
  if (capi_fullrotmat_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `fullrotmat' of fodmc.fodmc_mod.rotate_pos to C/Fortran array" );
  } else {
    fullrotmat = (double *)(PyArray_DATA(capi_fullrotmat_tmp));
  ...
  if (capi_xyz1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 2nd argument `xyz1' of fodmc.fodmc_mod.rotate_pos to C/Fortran array" );
  } else {
  ...
  if (capi_center_xyz_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 3rd argument `center_xyz' of fodmc.fodmc_mod.rotate_pos to C/Fortran array" );
  } else {
    center_xyz = (double *)(PyArray_DATA(capi_center_xyz_tmp));
  ...
  if (capi_xyz2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting hidden `xyz2' of fodmc.fodmc_mod.rotate_pos to C/Fortran array" );
  } else {
    xyz2 = (double *)(PyArray_DATA(capi_xyz2_tmp));
...
/***************************** rotate_around_axis *****************************/
static char doc_f2py_rout_fodmc_fodmc_mod_rotate_around_axis[] = "\
...
"stepsize : input float";
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_rotate_around_axis(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,double*,double*,double*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOO:fodmc.fodmc_mod.rotate_around_axis",\
...
/*frompyobj*/
  ...
  if (capi_axis_vector_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `axis_vector' of fodmc.fodmc_mod.rotate_around_axis to C/Fortran array" );
  } else {
    axis_vector = (double *)(PyArray_DATA(capi_axis_vector_tmp));
  ...
  if (capi_center_of_bond_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 2nd argument `center_of_bond' of fodmc.fodmc_mod.rotate_around_axis to C/Fortran array" );
  } else {
    center_of_bond = (double *)(PyArray_DATA(capi_center_of_bond_tmp));

  /* Processing variable stepsize */
    f2py_success = double_from_pyobj(&stepsize,stepsize_capi,"fodmc.fodmc_mod.rotate_around_axis() 4th argument (stepsize) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_xyz_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 3rd argument `xyz' of fodmc.fodmc_mod.rotate_around_axis to C/Fortran array" );
  } else {
...
/********************************* per_vector *********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_per_vector[] = "\
...
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_per_vector(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,double*,double*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:fodmc.fodmc_mod.per_vector",\
...
/*frompyobj*/
  ...
  if (capi_bond_vec_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `bond_vec' of fodmc.fodmc_mod.per_vector to C/Fortran array" );
  } else {
  ...
  if (capi_center_xyz_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 2nd argument `center_xyz' of fodmc.fodmc_mod.per_vector to C/Fortran array" );
  } else {
    center_xyz = (double *)(PyArray_DATA(capi_center_xyz_tmp));
  ...
  if (capi_per_vec_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 3rd argument `per_vec' of fodmc.fodmc_mod.per_vector to C/Fortran array" );
  } else {
...
/******************************** cart_to_frac ********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_cart_to_frac[] = "\
...
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_cart_to_frac(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,double*,double*,double*,double*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO:fodmc.fodmc_mod.cart_to_frac",\
...
/*frompyobj*/
  ...
  if (capi_veca_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 1st argument `veca' of fodmc.fodmc_mod.cart_to_frac to C/Fortran array" );
  } else {
  ...
  if (capi_vecb_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 2nd argument `vecb' of fodmc.fodmc_mod.cart_to_frac to C/Fortran array" );
  } else {
  ...
  if (capi_vecc_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 3rd argument `vecc' of fodmc.fodmc_mod.cart_to_frac to C/Fortran array" );
  } else {
  ...
  if (capi_pos_cart_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 4th argument `pos_cart' of fodmc.fodmc_mod.cart_to_frac to C/Fortran array" );
  } else {
  ...
  if (capi_pos_frac_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 5th argument `pos_frac' of fodmc.fodmc_mod.cart_to_frac to C/Fortran array" );
  } else {
...
/******************************** struct_motif ********************************/
static char doc_f2py_rout_fodmc_fodmc_mod_struct_motif[] = "\
...
/*  */
static PyObject *f2py_rout_fodmc_fodmc_mod_struct_motif(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO:fodmc.fodmc_mod.struct_motif",\
    capi_kwlist,&n_point_tot_capi,&n_point_capi,&radius_capi,&nuc_pos_capi,&position_point_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable n_point_tot */
    f2py_success = int_from_pyobj(&n_point_tot,n_point_tot_capi,"fodmc.fodmc_mod.struct_motif() 1st argument (n_point_tot) can't be converted to int");
  if (f2py_success) {
  /* Processing variable n_point */
    f2py_success = int_from_pyobj(&n_point,n_point_capi,"fodmc.fodmc_mod.struct_motif() 2nd argument (n_point) can't be converted to int");
  if (f2py_success) {
  /* Processing variable radius */
    f2py_success = double_from_pyobj(&radius,radius_capi,"fodmc.fodmc_mod.struct_motif() 3rd argument (radius) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_nuc_pos_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 4th argument `nuc_pos' of fodmc.fodmc_mod.struct_motif to C/Fortran array" );
  } else {
  ...
  if (capi_position_point_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(fodmc_error,"failed in converting 5th argument `position_point' of fodmc.fodmc_mod.struct_motif to C/Fortran array" );
  } else {
...
static FortranDataDef f2py_fodmc_mod_def[] = {
  {"get_guess",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_get_guess,doc_f2py_rout_fodmc_fodmc_mod_get_guess},
  {"mc_step",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_mc_step,doc_f2py_rout_fodmc_fodmc_mod_mc_step},
  {"create_rotmat",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_create_rotmat,doc_f2py_rout_fodmc_fodmc_mod_create_rotmat},
  {"create_rotmat_bond",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_create_rotmat_bond,doc_f2py_rout_fodmc_fodmc_mod_create_rotmat_bond},
  {"rotate_pos",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_rotate_pos,doc_f2py_rout_fodmc_fodmc_mod_rotate_pos},
  {"rotate_around_axis",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_rotate_around_axis,doc_f2py_rout_fodmc_fodmc_mod_rotate_around_axis},
  {"per_vector",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_per_vector,doc_f2py_rout_fodmc_fodmc_mod_per_vector},
  {"cart_to_frac",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_cart_to_frac,doc_f2py_rout_fodmc_fodmc_mod_cart_to_frac},
  {"struct_motif",-1,{{-1}},0,NULL,(void *)f2py_rout_fodmc_fodmc_mod_struct_motif,doc_f2py_rout_fodmc_fodmc_mod_struct_motif},
  {NULL}
};

static void f2py_setup_fodmc_mod(char *get_guess,char *mc_step,char *create_rotmat,char *create_rotmat_bond,char *rotate_pos,char *rotate_around_axis,char *per_vector,char *cart_to_frac,char *struct_motif) {
  int i_f2py=0;
  f2py_fodmc_mod_def[i_f2py++].data = get_guess;
  f2py_fodmc_mod_def[i_f2py++].data = mc_step;
  f2py_fodmc_mod_def[i_f2py++].data = create_rotmat;
  f2py_fodmc_mod_def[i_f2py++].data = create_rotmat_bond;
  f2py_fodmc_mod_def[i_f2py++].data = rotate_pos;
  f2py_fodmc_mod_def[i_f2py++].data = rotate_around_axis;
  f2py_fodmc_mod_def[i_f2py++].data = per_vector;
  f2py_fodmc_mod_def[i_f2py++].data = cart_to_frac;
  f2py_fodmc_mod_def[i_f2py++].data = struct_motif;
}
extern void F_FUNC_US(f2pyinitfodmc_mod,F2PYINITFODMC_MOD)(void (*)(char *,char *,char *,char *,char *,char *,char *,char *,char *));
static void f2py_init_fodmc_mod(void) {
  F_FUNC_US(f2pyinitfodmc_mod,F2PYINITFODMC_MOD)(f2py_setup_fodmc_mod);
}
...
"Fortran 90/95 modules:\n""  fodmc_mod --- get_guess(),mc_step(),create_rotmat(),create_rotmat_bond(),rotate_pos(),rotate_around_axis(),per_vector(),cart_to_frac(),struct_motif()"".");
...
/*eof initf2pywraphooks*/
  PyDict_SetItemString(d, "fodmc_mod", PyFortranObject_New(f2py_fodmc_mod_def,f2py_init_fodmc_mod));
/*eof initf90modhooks*/
