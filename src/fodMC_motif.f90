...
! Motif 8 -> twisted cube  (coordinates from optimized points on a sphere)
...
! Motif 9 -> twisted cube + 1 point at the side (coordinates from optimized points on a sphere)
...
! Motif 10 -> twisted cube + 2 points on a line (coordinates from optimized points on a sphere)
